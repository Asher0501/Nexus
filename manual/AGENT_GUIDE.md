...
**所有规则和模板都必须严格遵循 `manual/WORKFLOW_REFERENCE.md` 的定义。**
...
5. **调度时序 = edges，数据传递 = dataflows。** 两者独立，都需要分别声明才能正确工作。
...
按以下模板生成。所有 field 的完整定义见 `manual/WORKFLOW_REFERENCE.md`。
...
- **完整参考**: `manual/WORKFLOW_REFERENCE.md`（所有 schema、机制、模式模板、边界情况的唯一权威来源）
- **Architecture**: `manual/WORKFLOW_REFERENCE.md §1-3`
- **Node Protocol**: `manual/WORKFLOW_REFERENCE.md §4`（含 stdin/EOF 协议和 stderr 行为）
- **Architecture**: `design/ARCHITECTURE.md`
- **Node Protocol**: `design/NODE_PROTOCOL.md`
- **Mode Templates**: `manual/WORKFLOW_REFERENCE.md §6`
- **Integration Examples**: `manual/WORKFLOW_REFERENCE.md §7`
- **CLI & Debugging**: `manual/WORKFLOW_REFERENCE.md §9`
